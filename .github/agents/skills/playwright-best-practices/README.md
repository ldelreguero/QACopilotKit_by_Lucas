...
Source: [currents.dev](https://currents.dev?utm_source=ai-skill) - The all-in-one Dashboard for Playwright Testing.
...
In this repository, this skill is also the canonical source for transversal Playwright standards.

Agents and local skills should reference:
...
instead of duplicating long checklists about locators, waits, POM, assertions, naming, and structure.

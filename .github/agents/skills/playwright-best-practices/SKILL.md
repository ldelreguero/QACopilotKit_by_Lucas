...
## Canonical Use In This Repository

For this repository, treat `playwright-best-practices` as the single source of truth for transversal Playwright standards.

When another agent or skill needs to enforce Playwright quality, it should reference these files instead of redefining the same checklist:

- [quality-gate.md](references/quality-gate.md)
- [locators.md](references/locators.md)
- [test-organization.md](references/test-organization.md)
